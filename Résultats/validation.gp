...
set output 'Résultats/comparaison_convergence.png'
...
fit f_euler(x) "results/convergence_ExplicitEuler.dat" using 1:2 via a1, b1
fit f_rk2(x)   "results/convergence_RungeKutta2.dat" using 1:2 via a2, b2
fit f_rk4(x)   "results/convergence_RungeKutta4.dat" using 1:2 via a3, b3
...
# ==========================================
plot \
  "results/convergence_ExplicitEuler.dat" u 1:2 w p pt 7 ps 1.5 lc rgb "red" t "Euler Data", \
  f_euler(x) w l lw 2 lc rgb "red" dt 2 t t_euler, \
  "results/convergence_RungeKutta2.dat" u 1:2 w p pt 9 ps 1.5 lc rgb "blue" t "RK2 Data", \
  f_rk2(x)   w l lw 2 lc rgb "blue" dt 2 t t_rk2, \
  "results/convergence_RungeKutta4.dat" u 1:2 w p pt 5 ps 1.5 lc rgb "green" t "RK4 Data", \
